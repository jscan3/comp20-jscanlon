...
the distances between the user (passenger or vehicle) and their opposite.
...
Additionally, a second infoWindow function is called to display on an 
individual marker both the username and the distance between that passenger or 
driver and the user's current location. 
